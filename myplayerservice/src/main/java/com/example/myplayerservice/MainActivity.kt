package com.example.myplayerservice
...
import com.example.myplayer.MyAIDLInterface
import com.example.myplayerservice.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun onCreateMessengerService() {
        ...
        binding.messengerPlay.setOnClickListener {
            ...
            intent.setPackage("com.example.myplayer")
