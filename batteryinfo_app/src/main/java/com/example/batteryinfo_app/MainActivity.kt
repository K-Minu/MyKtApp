package com.example.batteryinfo_app
...
import com.example.batteryinfo_app.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener{
            val it = Intent(this, MyReceiver::class.java)
            sendBroadcast(it)
        }
    }
}
